...
# fix this to remove non-noun "CAN"s etc.
...
cooccurrence_windows_full <- cooccurrence_windows |> unnest(cor)
```

```{r}
ggplot(cooccurrence_windows_full |> 
         filter(before <= 100, after <= 100),
